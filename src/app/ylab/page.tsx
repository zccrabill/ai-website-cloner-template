...
const TITLE = "Y Lab — Youth Leadership & Business";
const DESCRIPTION =
  "Y Lab is a youth-led legal and business lab for teen entrepreneurs — real legal backup on a discounted membership, a podcast for the next generation of founders, and a teen-led push to change Colorado law so under-18s can form LLCs and sign contracts. Attorney-guided by Zachariah Crabill.";
...
const YLAB_FAQS = [
  ...
  },
  {
    ...
    answer:
      "Yes, with a structure that respects the current law. Because a minor's contract is generally voidable in Colorado, the parent or guardian is the account holder and payer, and the teen is the named participant who works day-to-day with our AI assistant and attorney. That friction — needing an adult to sign — is exactly the barrier Y Lab exists to change.",
  },
  {
    question: "How much does a Y Lab membership cost?",
    answer:
      "Y Lab mirrors Available Law's regular memberships at a 20% youth discount. Build is $40/month (vs. $50) and Grow is $120/month (vs. $150), each including monthly attorney work — a reviewed document or a 30-minute consult — plus unlimited AI legal chat. Annual billing saves more.",
  },
  {
    question: "What is the law you're trying to change?",
    answer:
      "In Colorado today, minors generally can't form an LLC on their own and the contracts they sign are voidable, which makes it hard for young people to start real, bankable businesses. Y Lab organizes and supports teen founders to lead a push to update Colorado law so under-18 entrepreneurs can form LLCs and enter enforceable contracts. The effort is youth-led and attorney-guided.",
  },
];
  ...
  return (
    <>
      <JsonLd
        data={[
          serviceSchema({
            name: "Y Lab Teen Founder Membership",
            description:
            ...
            priceCurrency: "USD",
            offerDescription:
              "Y Lab Build $40/mo, Grow $120/mo — a 20% youth discount off the regular memberships. Parent/guardian holds the account.",
          }),
