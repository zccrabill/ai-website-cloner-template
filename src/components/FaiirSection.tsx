      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="flex flex-col items-center text-center mb-16">
          ...
          <p className="text-lg text-[#6B5B4E] max-w-2xl leading-relaxed">
            FAIIR (Framework for AI Integration & Industry Responsibility) is
            the certification standard for attorneys who responsibly integrate
            artificial intelligence into client work. Available Law is proudly
            FAIIR Certified.
          </p>
        </div>
        ...
        <div className="bg-[#1F1810] rounded-2xl p-10 md:p-12 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          ...
          <a
            ...
            className="px-6 py-3 bg-[#C17832] text-white rounded-full text-sm font-medium hover:bg-white hover:text-[#1F1810] transition-all whitespace-nowrap flex-shrink-0"
          >
            Work with FAIIR Counsel →
          </a>
        </div>
      </div>
    </section>
